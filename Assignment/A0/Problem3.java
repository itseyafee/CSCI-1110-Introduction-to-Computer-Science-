 ...
 * calculates average activity time and then calculates the most active day and total activity that day and prints
 * a graph of stars in front of the dates.
 * @author Eyafee Al Hossain - B00904384
 */
public class Problem3 {
    public static void main(String[] args) {
        ...
        histogram(activity_array,month_days);
    }
    ...
    /**
     * This method prints the stars for the histogram
     * @param array the array containing the activity minutes
     * @param days the number of elements for the array
     * @return
     */
    public static void histogram(int[] array, int days){
        for (int i = 0; i < days; i++) {

            System.out.print(i+1+ " ");

            int stars = array[i] /10;
